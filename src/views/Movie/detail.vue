<template>
   <div id="detailContrainer" class="slice-enter-active">
        <Header title="影片详情">
...
<style scoped>
#detailContrainer{position: absolute;left: 0;top: 0;z-index: 100;width: 100%;min-height: 100%;background: #ccc;}
#detailContrainer.slice-enter-active{animation: .5s slideMove;}
@keyframes slideMove{
